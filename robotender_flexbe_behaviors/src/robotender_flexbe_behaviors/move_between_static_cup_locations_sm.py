...
'''
class movebetweenstaticcuplocationsSM(Behavior):
	'''
	Move between static positions for cups.
	'''


	def __init__(self):
		super(movebetweenstaticcuplocationsSM, self).__init__()
		self.name = 'move between static cup locations'
